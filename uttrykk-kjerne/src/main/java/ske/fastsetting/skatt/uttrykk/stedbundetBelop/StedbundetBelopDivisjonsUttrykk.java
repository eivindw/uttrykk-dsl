...
public class StedbundetBelopDivisjonsUttrykk<K> extends DivisjonsUttrykk<StedbundetBelop<K>,
  StedbundetBelopUttrykk<K>, StedbundetBelopDivisjonsUttrykk<K>> implements StedbundetBelopUttrykk<K> {
