...
*/
class TilStedbundetBelopUttrykk<K> extends AbstractUttrykk<StedbundetBelop<K>,TilStedbundetBelopUttrykk<K>> implements StedbundetBelopUttrykk<K> {
    private Uttrykk<StedbundetBelop<K>> uttrykk;

    public static <T> Collection<StedbundetBelopUttrykk<T>> tilStedbundetBelopUttrykk(Collection<Uttrykk<StedbundetBelop<T>>> uttrykk) {
