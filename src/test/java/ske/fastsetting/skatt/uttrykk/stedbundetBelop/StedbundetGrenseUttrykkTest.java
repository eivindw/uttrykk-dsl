...
public class StedbundetGrenseUttrykkTest {
    ...
    public void testToStederBegrensOppadUnderGrense() {
        StedbundetBelopUttrykk<String> uttrykk = begrensFordholdmessig(kr(25,"A").pluss(kr(50,"B"))).oppad(KroneUttrykk.kr(100));
    ...
    public void testToStederBegrensOppadOverGrense() {
        StedbundetBelopUttrykk<String> uttrykk = begrensFordholdmessig(kr(100,"A").pluss(kr(50,"B"))).oppad(KroneUttrykk.kr(100));
    ...
    public void testToStederBegrensNedadOverGrense() {
        StedbundetBelopUttrykk<String> uttrykk = begrensFordholdmessig(kr(25,"A").pluss(kr(50,"B"))).nedad(KroneUttrykk.kr(50));
    ...
    public void testToStederBegrensNedadUnderGrense() {
        StedbundetBelopUttrykk<String> uttrykk = begrensFordholdmessig(kr(25,"A").pluss(kr(50,"B"))).nedad(KroneUttrykk.kr(100));
