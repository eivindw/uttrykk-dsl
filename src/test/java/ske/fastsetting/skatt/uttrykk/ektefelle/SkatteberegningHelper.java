...
public class SkatteberegningHelper {
    ...
    public static final BelopUttrykk MINSTE_JORDBRUKSFRADRAG = kr(63500);
    public static final BelopUttrykk MAKS_JORDBRUKSFRADRAG = kr(166400);
    public static final TallUttrykk JORDBRUKS_FRADRAG_SATS = prosent(38);
